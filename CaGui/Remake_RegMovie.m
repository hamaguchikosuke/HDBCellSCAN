function Remake_RegMovie(ops, ichannel)

ops_local=ops;
ops_local.RegFile=strrep(ops_local.RootDir,'F:\','D:\'); % to use this in my note PC
...
fs = ops.fsroot; % fs{1}.name = 'F:\home\ImagingData\DualLickMice\b6j449\20161122\1\b6j449d166.tif'
