function Fcell = get_signals_NEUmodel_kh(ops)

fullloadname = sprintf('%s/F_%s_%s_plane%d_Ch%d_Nk%d.mat', ops.ResultsSavePath, ...
        ops.mouse_name, ops.date, ops.PlaneID,ops.ChannelID, ops.Nk);
    
fullsavename = fullloadname;
...
try
    save(fullsavename,  'ops', 'res', 'stat', ...
