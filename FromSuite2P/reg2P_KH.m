function ops1 = reg2P_KH(ops)
%% 
%  modified version of reg2P 
% 1) corrected several tiff read functions to read >4GB Tiff file.
...
%                 data = img.loadFrames(fs{k}(j).name, ichanset(1), ichanset(2), ichanset(3));                
                data = loadFramesBuff2(ops.temp_tiff, ichanset(1), ichanset(2), ichanset(3));               
            end
