...
% 
% 20171102: added microID 'o'= Olympus FVMPE-RS
% output um2pix.xPU (um/pix)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

if ~any(strcmp(microID, {'b', 'b2', 'm','o'}))
...
switch microID
    ...
    case 'o'
        zoom = [1,2,3,4];
        measuredHoriz = [500 250 125 62.5];
        measuredVert = [500 250 125 62.5];
        fitfunc = 'exp2';
end

curve = fit(zoom', measuredHoriz', fitfunc);
sizeHoriz = curve(zoomMicro);
curve = fit(zoom', measuredVert', fitfunc);
